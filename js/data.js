...
const featuresData = [
  ...
  },
  {
    ...
    title: "Privacy Guard",
    description: "Advanced protection against tracking and data collection using tools and strategies to safeguard personal information and maintain privacy online.",
  },
  {
    ...
    description: "Military-grade file shredding ensures complete data security by permanently deleting files using advanced algorithms that overwrite data multiple times, making it irretrievable. This process complies with strict security standards, protecting sensitive information from unauthorized recovery.",
  },
  {
    ...
    description: "Real-time system monitoring tracks system performance, resource usage, and potential issues continuously. AI analyzes this data instantly to provide optimization suggestions, such as adjusting configurations or resolving inefficiencies, ensuring peak performance and reliability.",
  },
  {
    ...
    title: "Cloud Backup",
    description: "Automatic backup ensuring important files are regularly copied to secure cloud storage without manual intervention. This safeguards data against loss or damage, providing accessibility and recovery from any location.",
  },
  {
    ...
    title: "Custom Rules",
    description: "Personalized cleanup and optimizing rules allowing users to set custom criteria for managing files, applications, and system resources. This ensures targeted performance improvements and efficient use of storage tailored to individual needs.",
  },
];
